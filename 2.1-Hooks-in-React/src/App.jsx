...
function App() {
  ...
  const incrementCount = () => {
    ...
    */
    ...
    /* Now here the logic will be different, it might seem like a same operation but the setCount is passed with a arrow function which will take the previous value of the count and than increment it unlike the previous operation.*/

    /* This ensures that each setCount call operates on the latest state, avoiding issues with batching. The console.log(count) statements, however, will still print the current value of count (not the updated value), as setState is asynchronous. */
